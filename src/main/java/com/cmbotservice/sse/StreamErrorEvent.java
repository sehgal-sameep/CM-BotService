...
/**
 * Payload for the {@link SseEventType#ERROR} event. {@code errorMessage} is always a generic,
 * client-safe description — internal exception details/stack traces are logged server-side only,
