...
/**
 * Marker for the seven SSE payload records that make up this service's outbound event
...
public sealed interface ChatSseEvent
        permits StreamStartEvent, MessageChunkEvent, ToolCallEvent, ToolResultEvent, CaseSummaryEvent,
