 ...
 * own contract guarantees but which {@link HttpMlAgentClient} still validates rather
 * than trusting blindly (consistent with this service's "never trust the agent
 * blindly" stance):
 * <ul>
